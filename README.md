...
**Chưa làm:** sửa/xoá thẻ trên web · import/export trong `apps/web` (bản `web/` cũ có) · PWA manifest
chưa port · mode **Playback** (nghe thụ động chạy nền) · highlight in-page · deploy Vercel thật
